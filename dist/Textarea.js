 ...
 * @returns
 */
const renderTextarea = (control) => (react_1.default.createElement(react_bootstrap_1.Form.Control, Object.assign({ type: 'textarea', as: 'textarea', key: `${control.name}-${_1.randomId()}` }, control)));
